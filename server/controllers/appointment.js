...
export const getAppointment = createHandler(appointmentService.getAppointment, 200);

// Update appointment handler
export const updateAppointment = createHandler(appointmentService.updateAppointment, 200);
