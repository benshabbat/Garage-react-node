import { useServiceAdminTableData } from "./useServiceAdminTableData";

export function useServiceAdminTableRows() {
  const { displayServices, handleSearch, handleServiceIdAction, handleExport } =
    useServiceAdminTableData();
  ...
  return { trTh, trTd, handleSearch, handleExport };
}
